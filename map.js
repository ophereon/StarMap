$(document).ready(function() {
	...
	if(canvas.getContext){
		...
		function draw(){
			...
			ctx.globalAlpha = (1/z)/4;
			ctx.drawImage(document.getElementById('nebula'), 0, 0, w, h);
			ctx.globalAlpha = 1.0;
			for(var i=0; i<=300; ++i) {
				drawLine(i*(cw/300), 0, i*(cw/300), ch, "rgb(50,50,50)");
			}
			for(var i=0; i<=300; ++i) {
				drawLine(0, i*(ch/300), cw, i*(ch/300), "rgb(50,50,50)");
			}
		}
